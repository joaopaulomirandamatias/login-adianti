...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        //Adicionar o título no formulário
       // $this->form->setFormTitle( 'LOG IN' );
        ...
        $btn->class = 'login100-form-btn'; //botão adicionado no formulário de login
        $btn->style = 'height: 40px;width: 70%;display: block;margin: auto;font-size:17px;';
